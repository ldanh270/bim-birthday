	...
	return (
		<div className="w-full h-screen relative bg-gradient-to-b from-[#E0F2FE] via-[#BAE6FD] to-[#7DD3FC] overflow-hidden">
			...
			>
				...
				<div
					className={`relative z-20 flex flex-col items-center justify-center transition-all duration-[1000ms] ${isOpened ? "opacity-0 scale-90 blur-md" : "opacity-100 scale-100"}`}
				>
					...
					<div className="relative w-[85vw] max-w-md aspect-[3/4.5] bg-white/80 backdrop-blur-md border-[6px] border-white shadow-[0_20px_60px_rgba(255,182,193,0.3)] rounded-[3rem] p-10 flex flex-col items-center justify-between text-center overflow-hidden">
						...
						<div className="absolute top-0 left-0 w-24 h-24 text-[#FFB6C1] opacity-40 rotate-0 p-4">
							🌸
						</div>
						<div className="absolute top-0 right-0 w-24 h-24 text-[#FFB6C1] opacity-40 rotate-90 p-4">
							🌸
						</div>
						<div className="absolute bottom-0 left-0 w-24 h-24 text-[#FFB6C1] opacity-40 -rotate-90 p-4">
							🌸
						</div>
						<div className="absolute bottom-0 right-0 w-24 h-24 text-[#FFB6C1] opacity-40 180 p-4">
							🌸
						</div>
						...
						<div className="flex flex-col items-center mt-6">
							...
							<h3 className="text-[12px] uppercase tracking-[0.4em] text-[#FFB6C1] mb-3 font-serif font-bold">
								Sweetest Birthday
							</h3>
							<h2 className="text-4xl md:text-5xl font-serif text-[#FF8E9E] mb-6 leading-tight italic">
								Happy Birthday, Bim
							</h2>
						...
						<div className="mb-4 text-[#FFB6C1] opacity-60 text-xl tracking-[0.5em]">✨ 🦋 ✨</div>
					</div>
				</div>
			</div>
