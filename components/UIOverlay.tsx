		...
		<div className="absolute inset-0 pointer-events-none z-10 flex flex-col items-center justify-between py-12">
			...
			<header className="flex flex-col items-center w-full px-4 animate-fade-in">
				<div className="flex items-center gap-4 mb-2">
					...
					<h1 className="text-4xl md:text-7xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-b from-[#38BDF8] via-[#3B82F6] to-[#60A5FA] drop-shadow-[0_2px_15px_rgba(255,142,158,0.3)] tracking-tight text-center italic">
						Happy Birthday Bim
					</h1>
					<span className="text-2xl opacity-40">✨</span>
				</div>
				<div className="w-32 h-[2px] bg-gradient-to-r from-transparent via-[#38BDF8] to-transparent"></div>
			</header>
			...
			<footer className="flex flex-col items-center gap-4 animate-fade-in opacity-80">
				<div className="bg-white/20 backdrop-blur-md border border-white/30 px-6 py-3 rounded-2xl shadow-xl flex items-center gap-6 pointer-events-auto transition-all hover:bg-white/30">
					<div className="flex items-center gap-2">
						<div
							className={`w-3 h-3 rounded-full ${!isChaos ? "bg-[#38BDF8] animate-pulse" : "bg-white/40"}`}
						></div>
					...
					<div className="flex items-center gap-2">
						<div
							className={`w-3 h-3 rounded-full ${isChaos ? "bg-[#FF8E9E] animate-pulse" : "bg-white/40"}`}
						></div>
